                ...
                <div class="form-group">
                    ...
                    <div class="form-row">
                        <div class="col date-field-container">
                            <input type="text" name="month" class="input-field-date"><label for="month" class="date-field">MM</label>
                        </div>
                        <div class="col date-field-container">
                            <input type="text" name="day" class="input-field-date"><label for="day" class="date-field">DD</label>
                        </div>
                        <div class="col date-field-container">
                            <input type="text" name="year" class="input-field-date"><label for="year" class="date-field">YYYY</label>
                        </div>
                    </div>
                </div>
